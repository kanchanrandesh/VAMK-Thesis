...
namespace VAMK.FWMS.WebSite.Controllers.WebAPI
{
    ...
    public class GroupController : ApiController
    {
        ...
        public IHttpActionResult SaveUsers(GroupModel model)
        {
            ...
            var newList = new List<GroupEmployee>();
            ...
            List<GroupEmployee> deleteList = dbGroupEmployees.Where(p => model.assignedList.All(p2 => p2.id != p.EmployeeID.Value.ToString() && p.EmployeeID.Value.ToString() != string.Empty)).ToList();
