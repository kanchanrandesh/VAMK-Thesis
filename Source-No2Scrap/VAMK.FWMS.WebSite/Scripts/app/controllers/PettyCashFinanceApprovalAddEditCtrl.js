angular.module('MetronicApp').controller('PettyCashFinanceApprovalAddEditCtrl', function ($rootScope, $scope, $http, $timeout, $document,
    ...
    $scope.headerTitle = 'Petty Cash Finance Approval';
    ...
    $scope.approve = function (obj) {
        ...
        pettyCashService.finApproval(obj).then(function (res) {
            if (res.status == true) {
