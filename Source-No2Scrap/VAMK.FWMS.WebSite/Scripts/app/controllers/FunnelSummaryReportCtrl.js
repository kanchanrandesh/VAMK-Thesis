angular.module('MetronicApp').controller('FunnelSummaryReportCtrl', function ($rootScope, $q, $scope, $state, companyService, financialYearService, financialPeriodService, opportunityService, notificationMsgService) {
    ...
    $scope.generate = function () {
        ...
        opportunityService.printFunnelSummaryReport($scope.search).then(function (res) {
        });
    };
