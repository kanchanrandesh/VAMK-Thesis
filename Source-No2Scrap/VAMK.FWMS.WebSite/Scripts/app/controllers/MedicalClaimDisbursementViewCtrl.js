angular.module('MetronicApp').controller('MedicalClaimDisbursementViewCtrl', function ($rootScope, $scope, $http, $timeout, $document,
    ...
    $scope.cancel = function () {
        $state.go('medicalClaimDisbursementList', {});
    }
