angular.module('MetronicApp').controller('MedicalClaimFinanceReportFilterCtrl', function ($rootScope, $scope, $state, notificationMsgService, medicalClaimService, companyService, employeeService) {
    ...
    $scope.generate = function () {
        ...
        if ($scope.selectedCompany)
            filter.companyIds = $scope.selectedCompany.id;
        else {
            notificationMsgService.showErrorMessage('Company need to be selected');
            return;
        }
