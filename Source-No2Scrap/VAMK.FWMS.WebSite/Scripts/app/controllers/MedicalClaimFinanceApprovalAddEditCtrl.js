angular.module('MetronicApp').controller('MedicalClaimFinanceApprovalAddEditCtrl', function ($rootScope, $scope, $http, $timeout, $document,
    ...
    $scope.headerTitle = 'Claim Finance Approval';
    ...
    $scope.approve = function (obj) {
        ...
        medicalClaimService.finApproval(obj).then(function (res) {
            if (res.status == true) {
