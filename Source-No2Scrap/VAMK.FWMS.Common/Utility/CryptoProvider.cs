...
namespace VAMK.FWMS.Common.Utility
{
    /// <summary>
    /// This class provide the Security Hash for the password token and validation methods
    /// </summary>
        ...
        public string GenerateSaltedHashString(string plainPassword, string slat, int id)
        {
            try
            {
                return Convert.ToBase64String(
                                   new VAMK.FWMS.Common.Utility.CryptoProvider().GenerateSaltedHash(
