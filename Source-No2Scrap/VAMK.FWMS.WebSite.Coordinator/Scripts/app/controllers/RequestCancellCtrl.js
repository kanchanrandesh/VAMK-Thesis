angular.module('MetronicApp').controller('RequestCancelCtrl', function ($rootScope, $scope, $http, $timeout, $document, $uibModal, $stateParams, $state, requestService, itemService, recipientService, notificationMsgService) {
    ...
    $scope.void = function (obj, frm) {
        ...
        if (frm.$valid) {
            ...
            requestService.void(obj).then(function (res) {
                if (res.status == true) {
                    notificationMsgService.showSuccessMessage('Request cancelled successfully. Request Number  : ' + res.transacionNumber);
