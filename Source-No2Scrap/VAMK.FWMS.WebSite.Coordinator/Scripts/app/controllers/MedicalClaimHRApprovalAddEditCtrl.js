angular.module('MetronicApp').controller('MedicalClaimHRApprovalAddEditCtrl', function ($rootScope, $scope, $http, $timeout, $document,
    $uibModal, $stateParams, $state, medicalClaimService, notificationMsgService) {
    var $ctrl = this;
    ...
    $scope.approve = function (obj) {
        ...
        medicalClaimService.medicalClaimHRApproval(obj).then(function (res) {
            if (res.status == true) {
    ...
    $scope.openModel = function (size, parentSelector, currentItemIndex) {
        ...
        var modalInstance = $uibModal.open({
            ...
            controller: 'MedicalClaimHRApprovalInstanceCtrl',
            controllerAs: '$ctrl',
